...
let namaSaya : string = "Reynaldy Septian" // : string ini adalah assigment pada varabel namaSaya sebagai strings
...
// Array strings
let namaKucings : string[] = ["bintik", "oren", "sapi"]
console.log("nama-nama kucing: ", namaKucings)

// Array Number 
let umurKucings : number[] = [2, 2, 3]
console.log("umur para kucing: ", umurKucings )

// Array boolean 
let isKucingsFat : boolean[] = [true, false, false]
console.log("apakah para kucing gendut: ", isKucingsFat )

// Tuple
let dataKucing : [string, number, boolean] = ["bintik", 2, true]
...
let temanAku: TemanType = {
    nama:"Guntur",
    isKampret: true,
    umur: 25
}
let temanKamu: TemanType = {
    nama:"Johan",
    isKampret: true,
}
...
let reynaldySeptian : Gender = "Laki-laki"
console.log({reynaldySeptian})

let gisell : Gender = true
console.log({gisell})
